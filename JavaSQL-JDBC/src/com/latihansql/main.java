...
//	static Scanner sc = new Scanner(System.in);
	...
	static void showMenu() {
		...
		System.out.println("3. Hapus data yang sudah di input");
		...
		try {
			...
			case 3:
				...
				deleteData();
			case 4:
				System.out.println("Anda telah keluar dari menu ini");			
				System.exit(0);
			}
		}catch (Exception e) {
			e.printStackTrace();
...
//				String qry = "INSERT INTO `mahasiswa`(`nim`, `nama`, `alamat`, `umur`) VALUES (%d,'%s','%s',%d)";
		        ...
		        for(int i = 0; i<lamapinjam;i++) {
		        	double prevValue = sisapinjaman;
		        	double currValue = prevValue - platfon - angsuranPokok;
